<%@ Page Title="" Language="C#" MasterPageFile="~/Content/AdminPanel.Master" AutoEventWireup="true" CodeBehind="CountryList.aspx.cs" Inherits="Net_Project6.Admin_Panel.Country.CountryList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMainContent" runat="server">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="col-md-12">
                    <asp:HyperLink runat="server" ID="hlAddCountry" Text="Add New Country" NavigateUrl="~/Admin Panel/Country/Add" CssClass="btn btn-info" ></asp:HyperLink>
                </div>
            <br />
            <br />
            <br />
            <asp:GridView runat="server" ID="gvCountry"  CssClass="table table-hover table-responsive table-bordered table-hover"   AutoGenerateColumns="false" OnRowCommand="gvCountry_RowCommand">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Edit">
                        <ItemTemplate>
                            <asp:HyperLink runat="server" Id="hlEdit" Text="Edit"  CssClass="btn btn-primary" NavigateUrl='<%# "~/Admin Panel/Country/Edit/" + Eval("CountryID").ToString() %>'/>
                        </ItemTemplate>
                    </asp:TemplateField>
